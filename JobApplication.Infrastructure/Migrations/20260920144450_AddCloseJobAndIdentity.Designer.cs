...
namespace JobApplication.Infrastructure.Migrations
{
    ...
    [Migration("20260920144450_AddCloseJobAndIdentity")]
    partial class AddCloseJobAndIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobApplication.Domain.Entities.Candidate", b =>
                {
                    b.HasOne("JobApplication.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("JobApplication.Domain.Entities.Job", b =>
                {
                    b.HasOne("JobApplication.Domain.Entities.User", "ClosedByUser")
                        .WithMany()
                        .HasForeignKey("ClosedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("JobApplication.Domain.Entities.User", "Recruiter")
                        .WithMany()
